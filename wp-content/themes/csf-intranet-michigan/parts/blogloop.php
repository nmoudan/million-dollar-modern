...
<?php /* <span class="post-format-icon colorb <?php echo get_post_format(); ?>"></span>  */ ?>
		<?php
...
<?php } ?>
<h6 class="blog-author"><?php esc_html_e('posted by','michigan'); ?> <?php the_author_posts_link(); ?>,</h6>&nbsp;
...
<?php /* <h6 class="blog-comments"><a class="hcolorf" href="<?php the_permalink(); ?>#comments"> <?php comments_number(  ); ?></a></h6> */ ?>
</div>
		</div>
	<?php
	...
	if( michigan_webnus_options::michigan_webnus_blog_featuredimage_enable() ) {
		...
		// gallery post type
			...
			if(has_post_thumbnail()){
				...
				if(michigan_webnus_options::michigan_webnus_no_image()){
					$no_image_src = (michigan_webnus_options::michigan_webnus_no_image_src())?michigan_webnus_options::michigan_webnus_no_image_src(): get_template_directory_uri().'/images/no_image.jpg';					
...
<div class="blgt1-inner">
 ...
 <?php  
	  if( 0 == michigan_webnus_options::michigan_webnus_blog_excerptfull_enable()  ) {
			...
			echo '... <br><br><a class="readmore colorf colorr hcolorr" style="float: left;float: left;margin-top: 10px;margin-right: 20px;" href="' . get_permalink($post->ID) . '">' . esc_html(michigan_webnus_options::michigan_webnus_blog_readmore_text()) . '</a>';
			echo '</p>';
			if( 'quote' == $post_format  ) echo '</blockquote>';
		} else {
			if( 'quote' == $post_format  ) echo '<blockquote>';
