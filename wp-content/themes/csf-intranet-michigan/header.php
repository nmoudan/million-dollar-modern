...
if(!function_exists( 'has_site_icon' ) || ! has_site_icon() ) {
	echo(michigan_webnus_options::michigan_webnus_apple_iphone_icon())?'<link rel="apple-touch-icon-precomposed" href="'.esc_url(michigan_webnus_options::michigan_webnus_apple_iphone_icon()).'">':'';
	echo(michigan_webnus_options::michigan_webnus_apple_ipad_icon())?'<link rel="apple-touch-icon-precomposed" sizes="72x72" href="'.esc_url(michigan_webnus_options::michigan_webnus_apple_ipad_icon()).'">':'';
	echo(michigan_webnus_options::michigan_webnus_fav_icon())?'<link rel="shortcut icon" href="'.esc_url(michigan_webnus_options::michigan_webnus_fav_icon()).'">':'<link rel="shortcut icon" href="'.esc_url(get_template_directory_uri()).'/images/favicon.ico">';
} 
...
echo(michigan_webnus_options::michigan_webnus_dark_submenu())? ' dark-submenu':'';
...
#if ( $topbar_show || is_archive() || is_single() || is_home() || $is_buddy ) :
if ( $topbar_show || is_archive() || is_single() || is_home() || is_search() || $is_buddy ) :
// Top Bar
...
if ( $header_show || is_archive() || is_single() || is_home() || is_search() || $is_buddy ) :
...
if($menu_type == 6 OR $menu_type == 7 ){ // Vertical
	// Header Background
	$header_background = (michigan_webnus_options::michigan_webnus_header_background())? 'style="background-size:cover; background-image: url(\''.michigan_webnus_options::michigan_webnus_header_background().'\')"':''; ?>
...
$logo = ( get_theme_mod( 'logo_image' ) ) ? get_theme_mod( 'logo_image' ) : michigan_webnus_options::michigan_webnus_logo();
$trendy = ( michigan_webnus_options::michigan_webnus_trendy_logo() ) ? michigan_webnus_options::michigan_webnus_trendy_logo() : $logo;
...
$transparent_logo = ( get_theme_mod( 'transparent_logo_image' ) ) ? get_theme_mod( 'transparent_logo_image' ) : michigan_webnus_options::michigan_webnus_transparent_logo();
$transparent_logo_width = preg_replace('#[^0-9]#','',strip_tags( get_theme_mod( 'transparent_logo_width' ) ? get_theme_mod( 'transparent_logo_width' ) : michigan_webnus_options::michigan_webnus_transparent_logo_width() ) );
...
$sticky_logo = ( get_theme_mod( 'sticky_logo_image' ) ) ? get_theme_mod( 'sticky_logo_image' ) : michigan_webnus_options::michigan_webnus_sticky_logo();
	...
	if(michigan_webnus_options::michigan_webnus_header_search_enable()){?>
		...
		<div id="gsearch-form">
		    <a href="javascript:void(0)" class="search-form-icon">
		        <i id="gsearchbox-icon" class="fa-search"></i>
		    </a>
		    <div id="gsearch-form-box" class="gsearch-form-box">
		        <form action="<?php echo site_url( 'rechercher/' ); ?>" method="get">
		            <input type="text" class="gsearch-text-box" id="gsearch-box" name="searchwpcs" data-swplive="true" data-swpconfig="supplemental_config" placeholder="Rechercher un document, un article.....">
		        </form>
		    </div>
		</div>
<?php }
...
if (get_theme_mod( 'enable_custom_colorskin' )){
	$colorskin = 'custom';
}elseif(michigan_webnus_options::michigan_webnus_color_skin() == 'none'){
	$colorskin = '';
}else{
	$colorskin = 'custom';
}
