...
switch_to_blog(1);
echo '<nav id="nav-wrap " class="'.$nav_class.'">
<div class="container"> ' . $components_header12 . '';
...
elseif($menu_type==8){
	...
	if ( has_nav_menu( $menu_location ) ) {
		...
		wp_nav_menu( array( 'theme_location' => $menu_location, 'container' => 'false', 'menu_id' => 'nav', 'depth' => '8', 'fallback_cb' => 'wp_page_menu', 'items_wrap' => '<ul id="%1$s">%3$s</ul>',  'walker' => new michigan_webnus_description_walker() ) );
		// global $blog_id;
