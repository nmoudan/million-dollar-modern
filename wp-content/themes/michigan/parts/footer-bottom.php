...
$w_fb_logo = '<img src="'.esc_url(michigan_webnus_options::michigan_webnus_footer_logo()).'" width="'.$w_logo_width.'" alt="">';
...
$w_fb_text = wp_kses( michigan_webnus_options::michigan_webnus_footer_copyright(), array( 'br' => array() ) );
