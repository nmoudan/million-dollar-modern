	...
	if(!function_exists('michigan_webnus_setup_vc_row')){
		...
		function michigan_webnus_setup_vc_row(){
			...
			$attributes = array(
							      ...
							      "description" => esc_html__("Predefined colors are greenbox,redbox,bluebox,yellowbox,gray. To use custom color please use below Cutom Background Color", "michigan"),
								  "value"=>"",
