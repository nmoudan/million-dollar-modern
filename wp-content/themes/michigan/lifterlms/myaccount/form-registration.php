...
?>
<div class="col-md-6 llms-new-person-form-wrapper">
<div class="w-reg-content">
    <h2 class="llms-title llms-h2"><?php esc_html_e( 'Register', 'lifterlms' ); ?></h2>
    <form method="post" class="llms-new-person-form register">
        ...
        <?php if ( 'no' === get_option( 'lifterlms_registration_generate_username' ) ) { ?>
            <div class="llms-form-item-wrapper username">
                <label for="reg_username"><?php esc_html_e( 'Username', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <?php if ( 'yes' === get_option( 'lifterlms_registration_require_name' ) ) : ?>
            ...
            <div class="llms-form-item-wrapper firstname">
                <label for="reg_firstname"><?php esc_html_e( 'First Name', 'lifterlms' ); ?> <span class="required">*</span></label>
            ...
            <div class="llms-form-item-wrapper lastname">
                <label for="reg_lastname"><?php esc_html_e( 'Last Name', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <?php if ( 'yes' === get_option( 'lifterlms_registration_add_phone' ) ) { ?>
            <div class="llms-form-item-wrapper phone">
                <label for="llms_phone"><?php esc_html_e( 'Phone', 'lifterlms' ); ?></label>
        ...
        <?php if ( 'yes' === get_option( 'lifterlms_registration_require_address' ) ) { ?>
            <div class="llms-form-item-wrapper billing_address_1">
                <label for="billing_address_1"><?php esc_html_e( 'Billing Address 1', 'lifterlms' ); ?> <span class="required">*</span></label>
            ...
            <div class="llms-form-item-wrapper billing_address_2">
                <label for="billing_address_2"><?php esc_html_e( 'Billing Address 2', 'lifterlms' ); ?></label>
            ...
            <div class="llms-form-item-wrapper billing_city">
                <label for="billing_city"><?php esc_html_e( 'Billing City', 'lifterlms' ); ?> <span class="required">*</span></label>
            ...
            <div class="llms-form-item-wrapper billing_state">
                <label for="billing_state"><?php esc_html_e( 'Billing State', 'lifterlms' ); ?> <span class="required">*</span></label>
            ...
            <div class="llms-form-item-wrapper billing_zip">
                <label for="billing_zip"><?php esc_html_e( 'Billing Zip', 'lifterlms' ); ?> <span class="required">*</span></label>
            ...
            <div class="llms-form-item-wrapper billing_country">
                <label for="billing_country"><?php esc_html_e( 'Billing Country', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <div class="llms-form-item-wrapper email">
            <label for="reg_email"><?php esc_html_e( 'Email address', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <?php if ( 'yes' === get_option( 'lifterlms_registration_confirm_email' ) ) { ?>
            <div class="llms-form-item-wrapper email_confirm">
                <label for="reg_email_2"><?php esc_html_e( 'Re-enter your email address', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <div class="llms-form-item-wrapper password">
            <label for="reg_password"><?php esc_html_e( 'Password', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <div class="llms-form-item-wrapper password_2">
            <label for="password_2"><?php esc_html_e( 'Re-enter new password', 'lifterlms' ); ?> <span class="required">*</span></label>
        ...
        <?php if ( ! isset( $_GET['product-id'] ) ) { ?>
            <div class="llms-form-item-wrapper voucher-wrapper">
                ...
                <a href="#" class="voucher-expand-button colorf" id="llms-voucher-expand"><?php esc_html_e( 'Have a Voucher?', 'lifterlms' ); ?></a>

                <div class="voucher-expand">
                    <label for="llms_voucher_code"><?php esc_html_e( 'Voucher Code', 'lifterlms' ); ?></label>
                    <input type="text" id="llms_voucher_code" placeholder="<?php esc_html_e( 'Voucher Code', 'lifterlms' ); ?>" name="llms_voucher_code">
                </div>
            </div>
        <?php } ?>
        <?php if ( 'yes' === get_option( 'lifterlms_registration_require_agree_to_terms' ) && get_option( 'lifterlms_terms_page_id' ) ){ ?>
            <div class="llms-form-item-wrapper agree_to_terms">
                ...
                <label for="agree_to_terms">
                    <?php printf( esc_html__( 'I have read and agree to the <a href="%s">Terms and Conditions</a>', 'lifterlms' ), get_the_permalink( get_option( 'lifterlms_terms_page_id' ) ) ); ?>
        ...
        <div style="left:-999em; position:absolute;"><label for="trap"><?php esc_html_e( 'Anti-spam', 'lifterlms' ); ?></label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>
        ...
        <div class="llms-form-item-wrapper llms-submit-wrapper">
            ...
            <input type="submit" class="button colorb" name="register" value="<?php esc_html_e( 'Register', 'lifterlms' ); ?>" />
        </div>
...
</article><section id="main-content" class="container"> <div><div>