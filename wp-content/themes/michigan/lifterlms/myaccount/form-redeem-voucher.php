...
<form method="POST">
	...
	<p class="form-row form-row-first">
		<label for="account_first_name"><?php esc_html_e( 'Voucher Code', 'lifterlms' ); ?></label>
		<input type="text" placeholder="<?php esc_html_e( 'Voucher Code', 'lifterlms' ); ?>" name="llms_voucher_code" required="required">
	</p>
